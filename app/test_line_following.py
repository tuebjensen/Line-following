...
def get_direction_calculator_state_string(direction_calculator_state):
    ...
    last_incoming_state: {direction_calculator_state["last_incoming_state"]}, \
    same_incoming_states_count: {direction_calculator_state["same_incoming_states_count"]}, \
    last_target: {direction_calculator_state["last_target"]}, \
    last_line: {direction_calculator_state["last_line"]}, \
    turning_just_initiated: {direction_calculator_state["turning_just_initiated"]},\
    path_plan: {get_path_plan_string(direction_calculator_state["path_plan"])}'
